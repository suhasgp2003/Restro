    ...
    <section id='dishes' className='px-auto mt-44'>
        ...
        <div className='grid grid-cols-2 md:grid-cols-4 gap-12 md:gap-18 max-w-5xl mx-auto'>
           {dishes.map((dish,index)=>(
            <Animated key={index} y={80} delay={index * 0.2} className='flex flex-col items-center text-center shrink-0 cursor-pointer' onMouseEnter={()=>setRotate((prev)=>({...prev,[index]:(prev[index] || 0 + 180)}))}>
