...
const Timing = () => {
  return (
    <section id='timing' className='px-auto mt-44'>
        ...
        className="w-full max-w-5xl h-162.5 rounded-3xl bg-cover bg-center flex items-center justify-content md:justify-start px-6 md:px-14 overflow-hidden mx-auto bg-[url('/assets/restro-timing.png')]">
          ...
          <div className='bg-white rounded-3xl p-8 w-full max-w-xs'>
             ...
             <Animated delay={0.2} className="mt-12 flex justify-center">
              <a href="#booking-process" className='bg-orange-500 hover:bg-orange-600 text-white font-medium px-6 py-3 rounded-full transition'>Book a table</a>
             </Animated>
        </div>   
